...
export default function Dashboard() {
  ...
  // const mapplsApiKey = "b7036904-69e0-4d7c-b830-f7c6df373e58"; // raj api key Replace with your API key 
  const mapplsApiKey = "188d5bec-8468-4bd5-ab97-c08222486ab1";  // my api key 
    ...
    try {
      const response = await fetch(
        // `https://nominatim.openstreetmap.org/search?format=json&countrycodes=IN&q=${encodeURIComponent(query)}`
           `https://atlas.mapmyindia.com/api/places/search/json?query=${encodeURIComponent(query)}&limit=5`
        //  `https://atlas.mapmyindia.com/api/places/search/json?query=<${encodeURIComponent(query)}>&pod=City&access_token=<188d5bec-8468-4bd5-ab97-c08222486ab1>`
